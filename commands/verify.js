...
module.exports = {
    ...
    execute(message, args) {
        ...
        collector.on('end', collected => {
            ...
            checkEmail = userEmail.replace('@', ' ');
            console.log(checkEmail);
            if (checkEmail.endsWith("ftstudent.org")) {
                console.log("Email ends in @ftstudent.org");
                const msg = {
            ...
            } else if (!checkEmail.endsWith("ftstudent.org")){
                console.log('false');
                message.channel.send("That email does not look like a school email! Please run -verify again or message @BifocalCanvas#0701 for help");
            }
